...
contract SimpleBank {
    ...
    /* OK Let's make sure everyone knows who owns the bank. Use the appropriate keyword for this*/
    ...
    constructor() public {
        /* OK Set the owner to the creator of this contract */
        owner = msg.sender; 
    }
    ...
    // OK A SPECIAL KEYWORD prevents function from editing state variables;
    // allows function to run locally/off blockchain
    function getBalance() public view returns (uint) {
        /* OK Get the balance of the sender of this transaction */
    ...
    // OK Emit the appropriate event    
    // OK Users should be enrolled before they can make deposits
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
        /* OK If the sender's balance is at least the amount they want to withdraw,
